...
function FoodsUpload() {
    ...
    // const [newUrlIsValid, setNewUrlIsValid] = useState(true);
    // const [newImageUrlIsValid, setNewImageUrlIsValid] = useState(true);
    // const [newTitleIsValid, setNewTitleIsValid] = useState(true);
    // const [newDescriptionIsValid, setNewDescriptionIsValid] = useState(true);
    ...
    const handleUpload = (e) => {
        ...
        // setNewDescriptionIsValid(true);
        // setNewUrlIsValid(true);
        // setNewTitleIsValid(true);
        // setNewImageUrlIsValid(true);
            ...
            <form method="post">
                <div className="row">
                    <div className="col">
                        ...
                        {/* {!newUrlIsValid && <p className="error-text">Url must not be empty</p>} */}
                    </div>
                    <div className="col">
                        <div className="mb-3">
                        ...
                        {/* {!newTitleIsValid && <p className="error-text">Title must not be empty</p>} */}
                    </div>
                </div>
                <div className="row">
                    <div className="col">
                        ...
                        {/* {!newImageUrlIsValid && <p className="error-text">Image url must not be empty</p>} */}
                    </div>
                </div>
                <div className="row">
                    <div className="col">
                        ...
                        {/* {!newDescriptionIsValid && <p className="error-text">Description must not be empty</p>} */}
                    </div>
                </div>
